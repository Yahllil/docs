...
[Screenshot of the Snippet Builder interface highlighting Step 3 ("Make It Perfect") and pointing specifically to the text input box labeled "What would you like to modify?".]
...
If you add a new field to your Airtable table *after* initially creating the snippet, you can instruct the prompt to include it in the display. (Remember to potentially refresh the builder page or schema first so Crust AI recognizes the new field).
...
<br/>*Learn more:* [Adding Interactive Elements to Update Data](/chapters/update-data-and-trigger-actions/adding-interactive-elements-to-update-data)
...
[Gif showing a user typing "Make the status a green chip if Active" into the prompt and the phone preview updating accordingly.]
...
[Screenshot highlighting the List View/Detail View toggle buttons above the phone preview, emphasizing the need to select the correct view before prompting.]
...
Think of the prompt as your way to style and arrange the data *after* it has been selected and filtered according to the rules set in Step 2.
