...
| **Preview**         | ![Single Item Snippet Preview](placeholder-single-item.png)  <br />_Screenshot of the Snippet Builder with "Single Item" selected and the phone preview showing a detailed view of one record._                                        | ![Multiple Items Snippet Preview](placeholder-multiple-items.png)  <br />_Screenshot of the Snippet Builder with "Multiple Items" selected and the phone preview showing a list view with multiple cards/items._                                                                                          |
