...
<iframe width="560" height="315" src="https://www.youtube.com/embed/v9FXZi8cI9E?si=JiLNSkEVpnH78YNT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
...
<Steps>
  <Step title="Select Snippet Type" titleSize="h2">
  ...
  <Step title="Select Data / Set Filters & Permissions" titleSize="h2">
  ...
  <Step title='Modify and Tweak the UI ("Make It Perfect with AI")' titleSize="h2">
  ...
  <Step title='Share ("Looking good?")' titleSize="h2">
