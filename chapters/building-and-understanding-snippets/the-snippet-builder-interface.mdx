...
[Screenshot showing the full Snippet Builder interface with the main control panel on the left, the phone preview on the right, and the numbered steps (1, 2, 3, 4) visible.]
...
3.  **Modify and Tweak the UI ("Make It Perfect")**: Customize the UI, visual design, layout, and add interactive elements.
...
[Screenshot highlighting the "Select Snippet Type" section with the two button options.]
...
[Screenshot showing the "Set Filters & Permissions" section with the Airtable table preview and controls for Filter, Sort, and Permission.]
...
<Tab title="Single Item">
  ...
  [Screenshot highlighting the table preview and a selected radio button next to a specific record when in Single Item mode.]
</Tab>
<Tab title="Multiple Items">
  ...
  [Screenshot highlighting the table preview when in Multiple Items mode, showing multiple rows selected by default.]
</Tab>
</Tabs>
...
### Multi-Items Data Access Configurations
  ...
  *   **Permission**: Control who can see the data. This is crucial for implementing user-based filtering.
  ...
  [Screenshot highlighting the "Data Access Configurations" box and the Filter, Sort, and Permission tabs.]
...
[Screenshot showing the "Make It Perfect" section with the phone preview on the right and customization controls/prompt area below it.]
...
[Screenshot highlighting the List View and Detail View toggle buttons above the phone preview.]
...
[Screenshot highlighting the AI prompt input text box.]
...
### Additional Controls
  ...
  **Full Screen Preview**: Use the full screen button to view the snippet preview in a larger format and see how it renders on a desktop screen as well as mobile.
  ...
  [Screenshot highlighting the Full Screen preview button icon.]
  ...
  **Layout Direction**: You can change the text and layout direction (Left-to-Right or Right-to-Left) to support languages like Hebrew or Arabic, ensuring your snippet is culturally and linguistically appropriate for your audience.
  ...
  [Screenshot of the Layout Direction button]
  ...
  **Edit Code**: For advanced technical users, there's an option to "Edit Code Manually". This allows you to directly access and modify the underlying React code of the snippet. Caution: This feature is for experienced developers only. Incorrect code changes can easily break your snippet. We recommend using the AI prompt and no-code options for most customizations.
  ...
  [Screenshot highlighting the "Edit Code" icon.]
...
[Screenshot highlighting the "Looking good?" section and the "Get Shareable URL" button.]
...
## Returning to the Snippets Directory

At any point, to go back to your main dashboard showing all your snippets, click the Crust AI logo/back button in the top left corner of the interface.

[Screenshot highlighting the Crust AI logo in the top left as the back button.]