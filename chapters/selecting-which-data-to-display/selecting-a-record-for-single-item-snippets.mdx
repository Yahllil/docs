...
[Screenshot of the Snippet Builder interface highlighting Step 2, specifically the table preview area with radio buttons next to each record.]
...
[Gif showing a user clicking the radio button next to a specific record in the table preview.]
...
[Screenshot of the modal showing the generated URL with the `?rec=` parameter highlighted.]
