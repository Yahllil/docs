...
<Steps>
  ...
  <Step title="Configure Airtable Button Field">
    ...
    *   Give the button a clear label in Airtable (e.g., "Send Welcome Email", "Generate PDF Report").
    ...
    [Screenshot of the Airtable interface showing the configuration of a Button field, with the "Open URL" action selected and a placeholder webhook URL in the formula box.]
  </Step>
  <Step title="Add Button to Snippet (Crust AI)">
    ...
    [Gif showing a user typing the prompt "Add a button to trigger the 'Notify Client' Airtable button" and a corresponding button appearing in the snippet preview.]
  </Step>
</Steps>
